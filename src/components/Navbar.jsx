      ...
      <nav>
        ...
        <div className={`mobile-navbar ${nav ? "open-nav" : ""}`}>
          ...
          <ul className="mobile-navbar__links">
            ...
            <li>
              <Link className="signin" onClick={openNav}  to="/SignUp">Sign In / Up</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="navbar">
          ...
          <ul className="navbar__links">
            ...
            <li>
              {" "}
              <Link className="models-link" to="/models">Vehicle Models</Link>
            </li>
            <li>
              {" "}
              <Link className="testi-link" to="/testimonials">Testimonials</Link>
            </li>
            <li>
              {" "}
          ...
          <div className="navbar__buttons">
            ...
            <Link className="navbar__buttons__register" to="/SignUp">Sign In / Up</Link>
